...
let project = "PeakSimulator"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "A short randomized simulator for peaks/whole chromatograms."

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "A short randomized simulator for peaks/whole chromatograms."

// List of author names (for NuGet package)
let author = "Kevin Frey"

// Tags for your project (for NuGet package)
let tags = "Chromatogram Simulator Simulation Peaks Peak"

// File system information
let solutionFile  = "PeakSimulator.sln"
...
let gitOwner = "Kevin Frey"
let gitHome = sprintf "%s/%s" "https://github.com" gitOwner

// The name of the project on GitHub
let gitName = "PeakSimulator"

// The url for the raw files hosted
let gitRaw = Environment.environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/Kevin Frey"

let website = "/PeakSimulator"
...
let info =
  [ "project-name", "PeakSimulator"
    "project-author", "Kevin Frey"
    "project-summary", "A short randomized simulator for peaks/whole chromatograms."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/PeakSimulator" ]
